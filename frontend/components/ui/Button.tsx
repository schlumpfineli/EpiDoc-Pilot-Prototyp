...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses = 'font-medium transition-all duration-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2';
  ...
  const sizeClasses = {
    sm: 'px-3 py-1.5 text-body-small rounded-xl',
    md: 'px-5 py-3.5 text-body rounded-2xl',
    lg: 'px-6 py-4 text-h5 rounded-2xl',
  };
